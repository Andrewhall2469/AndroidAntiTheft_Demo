...
public class TestCase1AdminButton {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void device_Administration_ToggleButton_Test() {

        ViewInteraction toggleButton = onView(
                allOf(ViewMatchers.withId(R.id.toggle_device_admin), withText("Device Admin Disabled"), isDisplayed()));
        ...
        ViewInteraction toggleButton3 = onView(
                allOf(withId(R.id.toggle_device_admin),
                        childAtPosition(
                                childAtPosition(
